...
class UserCharacterRepository(base_repository.BaseRepository):
    ...
    def _list_comprehension_by_index(self, iter, index):
    ...
    def get_grasp(self, user_id):
        ...
        return self._list_comprehension_by_index(grasp_characters, 0)
    ...
    def get_learning(self, user_id):
        ...
        return self._list_comprehension_by_index(learning_characters, 0)
